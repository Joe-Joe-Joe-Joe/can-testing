...
void main(void)
{
    ...
    can_msg_t msg_LEDs_on;
    msg_LEDs_on.data[0] = 0x00;
    msg_LEDs_on.data_len = 1;
    msg_LEDs_on.sid = 0x7E0;

    TRISC5 = 0;
    while(1)
    {
        mcp_can_send(&msg_LEDs_on);
        LATC5 = 0;
