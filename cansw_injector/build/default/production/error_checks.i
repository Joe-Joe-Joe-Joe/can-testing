...
if (batt_voltage_mV < 10000
|| batt_voltage_mV > 14000) {

uint32_t timestamp = millis();
uint8_t batt_data[2] = {0};
batt_data[0] = (batt_voltage_mV >> 8) & 0xff;
batt_data[1] = (batt_voltage_mV >> 0) & 0xff;
enum BOARD_STATUS error_code = batt_voltage_mV < 10000
? E_BATT_UNDER_VOLTAGE
: E_BATT_OVER_VOLTAGE;
...
if (valve_pin_state != 0b001110) {
uint8_t error_data[2] = {0};
error_data[0] = 0b001110;
...
if (valve_pin_state != 0b110001) {
uint8_t error_data[2] = {0};
error_data[0] = 0b110001;
error_data[1] = valve_pin_state;
